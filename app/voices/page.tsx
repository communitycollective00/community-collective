      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "3rem 1.5rem 2rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
          <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 12, padding: "1.5rem" }}>
            ...
            <p style={{ color: "var(--muted)", fontSize: "0.9rem", lineHeight: 1.6, marginBottom: "1rem" }}>Culture Collective amplifies lived experience, mentorship, and local expertise. Every voice is evidence that your access network is built on real relationships and real practice.</p>
            {whyCards.map((c, i) => (
